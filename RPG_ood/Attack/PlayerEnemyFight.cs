...
public abstract class PlayerEnemyFight(Player attacker, IEnemy defender)
{
    ...
    public abstract void VisitHeavyWeapon(HeavyWeapon usedWeapon, IUsable originalWeapon);
    public abstract void VisitLightWeapon(LightWeapon usedWeapon, IUsable originalWeapon);
    public abstract void VisitMagicalWeapon(MagicalWeapon usedWeapon, IUsable originalWeapon);
    public abstract void VisitOtherUsable(IUsable usedWeapon, IUsable originalWeapon);
...
public class NormalPlayerEnemyAttack(Player attacker, IEnemy defender) : PlayerEnemyFight(attacker, defender)
{
    public override void VisitHeavyWeapon(HeavyWeapon usedWeapon, IUsable originalWeapon)
    {
        AttackDamage = originalWeapon.Damage;
    ...
    public override void VisitLightWeapon(LightWeapon usedWeapon, IUsable originalWeapon)
    {
        AttackDamage = originalWeapon.Damage;
        AttackDamage = (int)(AttackDamage * 
    ...
    public override void VisitMagicalWeapon(MagicalWeapon usedWeapon, IUsable originalWeapon)
    {
        AttackDamage = 1;
        AttackDamage = Math.Max(AttackDamage - Defender.Armor, 0);
    ...
    public override void VisitOtherUsable(IUsable usedWeapon, IUsable originalWeapon)
    {
        AttackDamage = originalWeapon.Damage;
        AttackDamage = Math.Max(AttackDamage - Defender.Armor, 0);
...
public class SneakPlayerEnemyAttack(Player attacker, IEnemy defender) : PlayerEnemyFight(attacker, defender)
{
    public override void VisitHeavyWeapon(HeavyWeapon usedWeapon, IUsable originalWeapon)
    {
        AttackDamage = originalWeapon.Damage;
...
public class MagicPlayerEnemyAttack(Player attacker, IEnemy defender) : PlayerEnemyFight(attacker, defender)
{
    public override void VisitHeavyWeapon(HeavyWeapon usedWeapon, IUsable originalWeapon)
    {
        AttackDamage = 1;
